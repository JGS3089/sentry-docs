...
redirect_from:
  ...
  - /platforms/python/guides/wsgi/performance/connect-services/?utm_awesome=open-source&utm_campaign=fire&utm_source=readthedocs
  - /platforms/python/guides/wsgi/performance/instrumentation/
  - /platforms/python/guides/wsgi/data-management/
  - /platforms/python/guides/wsgi/enriching-events/breadcrumbs/
  - /platforms/python/guides/wsgi/configuration/draining/
  - /platforms/python/guides/wsgi/configuration/integrations/redis/
  - /platforms/python/guides/wsgi/profiling/
  - /product/issues/issue-details/performance-issues/main-thread-io/?utm_medium=https://www.zoost.ai/&utm_source=https://www.zoost.ai/&utm_content=https://www.zoost.ai/
  - /platforms/python/guides/wsgi/performance/instrumentation/performance-metrics/
  - /platforms/python/guides/wsgi/enriching-events/scopes/
  - /platforms/python/guides/wsgi/configuration/releases/
